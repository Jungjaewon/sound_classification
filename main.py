...
# Reference1 : https://mikesmales.medium.com/sound-classification-using-deep-learning-8bc2aa1990b7
# Reference2 : https://github.com/mikesmales/Udacity-ML-Capstone
# Reference3 : https://github.com/clcarwin/focal_loss_pytorch
...
def main(config):
    ...
    solver = Solver(config, get_loader(config, 'train'), get_loader(config, 'test'))
